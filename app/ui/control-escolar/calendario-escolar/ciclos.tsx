...
import { useGetCiclosQuery } from "@/redux/control-escolar/calendario/calendarioApiSlice";
...
export default function CiclosStatics() {
  const { data, error, isLoading, isSuccess } = useGetCiclosQuery();
  const dispatch = useAppDispatch();
  const { errorMessage, ciclos } = useAppSelector((state) => state.calendario);
