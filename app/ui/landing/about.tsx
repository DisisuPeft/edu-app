          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                ...
                educación. Somos una institución que forma profesionales
                altamente capacitados mediante programas académicos de
                excelencia, con enfoque humano, científico y práctico.
              </p>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                reales de crecimiento profesional en áreas clave como la salud,
                la educación y las ciencias humanas.
              </p>
