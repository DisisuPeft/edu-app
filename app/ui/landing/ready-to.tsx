  ...
  return (
    <div className="bg-[#121b6a] text-white py-12 px-6 rounded-lg text-center">
      <h2 className="text-2xl md:text-3xl font-bold mb-4">
        ¿Quieres dar el siguiente paso en tu desarrollo profesional?
      </h2>
      <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
        Sabemos que elegir el camino correcto es importante. Déjanos tus datos y
        un asesor te guiará sin compromiso.
      </p>
